...
| 26  | **A snapped arc**        | `fit: "content"` stops the width being the band's diameter, so a `WheelMenu` given one draws its second band in the wrong place                       |
