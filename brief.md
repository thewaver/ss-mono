...
| 26  | **Arbitrary placement across controls**             | Items placeable anywhere rather than along a line. Built: the `Placement` abstract, `Menu`'s optional layout, and the ring, hemisphere and fan. Left: the hold-and-flick gesture, concentric submenus, and the proving pass against `Paginator`.    |
