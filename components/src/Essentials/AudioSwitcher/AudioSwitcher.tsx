...
export const AudioSwitcher = (props: AudioSwitcherProps) => {
    ...
    createEffect(() => {
        ...
        if (src !== getCurrentSrc()) {
            const isFirstSrc = getCurrentSrc() === undefined;
            const shouldAutoPlayOnMount = access(props.shouldAutoPlayOnMount) ?? false;
            ...
            if (src) {
                ...
                if (!isFirstSrc || shouldAutoPlayOnMount || getIsPlaying()) fadeIn(active);
            }
        }
    });
