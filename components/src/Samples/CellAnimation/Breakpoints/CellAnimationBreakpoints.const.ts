...
const DEFAULT_EASING: CellAnimationBreakpoints.Easing = "linear";
const EASING_CONTROLS: Record<Exclude<CellAnimationBreakpoints.Easing, "linear">, [number, number, number, number]> = {
...
const computeEasedRatio = (easing: CellAnimationBreakpoints.Easing, ratio: number) => {
