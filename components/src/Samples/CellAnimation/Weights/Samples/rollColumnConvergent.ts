...
export const rollColumnConvergent: WeightFn = (pos, count, origin) => {
    ...
    return CellAnimationUtils.isEvenColumn(dist) ? 1 - dist.row / (maxDist.row * 2) : dist.row / (maxDist.row * 2);
};
