...
import type { MenuBranchConfig } from "./App.types";
...
export const MENU_ID = "library-menu";
...
export const EMPTY_DEPENDENCY_NAMES: DependencyNames = {
    abstracts: [],
    generators: [],
    primitives: [],
    components: [],
...
export const FIXED_ANCHOR_RATIO = { width: 16, height: 9 };
